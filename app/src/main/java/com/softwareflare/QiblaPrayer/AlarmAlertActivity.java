...
public class AlarmAlertActivity extends Activity {
    ...
    private Integer SNOOZE_TIME = 600; // 10 minutes
    ...
    private void snoozeAlarm() {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(this, Custom_alarm_activity.uniqueId, intent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
